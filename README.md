...
#
ClusterName=icemsvuw1
SlurmctldHost=icems_vuw_1
#SlurmctldHost=
#
# Authentication info
AuthType=auth/munge
...
#
# COMPUTE NODES
NodeName=icems_vuw_1 CPUs=32 RealMemory=192084 Sockets=2 CoresPerSocket=16 ThreadsPerCore=1 State=UNKNOWN
PartitionName=parallel Nodes=ALL Default=YES MaxTime=INFINITE State=UP
```
